...
namespace App {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UtilisateurDataTable : global::System.Data.TypedTableBase<UtilisateurRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UtilisateurRow AddUtilisateurRow(string nomUtil, string prenUtil) {
...
namespace App.DataSet1TableAdapters {
    ...
    public partial class UtilisateurTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT     u.nomUtil, u.prenUtil
FROM         Utilisateur AS u CROSS JOIN
                      Stationnement AS s
WHERE     (s.dateStat = @id) AND
                          ((SELECT     COUNT(s.idUtil) AS Expr1
                              FROM         Utilisateur AS u CROSS JOIN
                                                    Stationnement AS s
                              WHERE     (s.idUtil = u.idUtil)) >= 10)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "dateStat", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet1.UtilisateurDataTable dataTable, global::System.Nullable<global::System.DateTime> id) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((id.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(id.Value));
            }
            else {
        ...
        public virtual DataSet1.UtilisateurDataTable GetData(global::System.Nullable<global::System.DateTime> id) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((id.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(id.Value));
            }
